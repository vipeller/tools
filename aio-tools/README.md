...
## Installing WoT-Ingestion

WoT-Ingestion is a temporary solution to upload WoT-TD documents generated by akri connectors, until the connector itself cannot upload it. It works with the POC opc ua connector image.
```
helm install wot-ingestion charts/wot-ingestion-0.1.0.tgz \
  --namespace azure-iot-operations \
  --set image.repository=vipeller.azurecr.io/wot-ingestion \
  --set image.tag=0.1.0 \
